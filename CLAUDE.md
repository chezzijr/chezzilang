...
#   `tests/chz` (620 Chezzi behavioural tests) run at TWO worker counts (default + `CHEZZI_THREADS=2`)
...
**4433 Rust tests** green across 23 targets (**4202** in the lib target), plus **620**
