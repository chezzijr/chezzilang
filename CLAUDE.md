...
> not as a bug) — plus **1 deferred ticket** in `.project/tickets-deferred/` (083 — only its
> `pad_right` half is left). 082, 084 and 087 closed 2026-09-21 under TICKET-161, 160, 163. 086 and 090 closed 2026-09-22 under TICKET-086 and TICKET-090. The pipeline queue is EMPTY: 140 done, 3 rejected, 0 in flight. Wave 14's three
